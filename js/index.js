...
let addLocationAndTime = function(){
	$.getJSON("https://ipapi.co/json", function(data){
		...
		const placeTimeAndGreetingString = "<div class='place-and-time'>It's the <span id='time'>" + timeString +"</span> in <span id='place'>" + placeString + "</span></div><div class='greeting'>Hope you have a happy Christmas period and New Year where and when ever you are</div>";
